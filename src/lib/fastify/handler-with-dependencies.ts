...
export type DependencyInjectedHandler<
  THandler extends RequestReplyHandler,
  TRouteDependencies extends object,
...
>(
  ...
  dependencies: TRouteDependencies,
): (this: ThisParameterType<THandler>, ...args: Parameters<THandler>) => ReturnType<THandler> {
  return function dependencyInjectedHandler(this, request, reply) {
    return handler.call(this, { dependencies, reply, request });
  };
}
