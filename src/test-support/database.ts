...
const dropAllTablesSql =
  "DROP TABLE IF EXISTS graph_composition_subgraphs, graph_compositions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
...
const truncateAllDataSql =
  "TRUNCATE TABLE graph_composition_subgraphs, graph_compositions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
