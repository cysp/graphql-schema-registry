...
const dropAllTablesSql =
  "DROP TABLE IF EXISTS graph_composition_subgraph_schema_revisions, graph_composition_subgraph_revisions, graph_composition_graph_revisions, graph_compositions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
...
const truncateAllDataSql =
  "TRUNCATE TABLE graph_composition_subgraph_schema_revisions, graph_composition_subgraph_revisions, graph_composition_graph_revisions, graph_compositions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
