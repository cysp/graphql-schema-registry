...
const dropAllTablesSql =
  "DROP TABLE IF EXISTS supergraph_schema_revision_subgraphs, supergraph_schema_revisions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
...
const truncateAllDataSql =
  "TRUNCATE TABLE supergraph_schema_revision_subgraphs, supergraph_schema_revisions, subgraph_schema_revisions, subgraph_revisions, subgraphs, graph_revisions, graphs CASCADE";
