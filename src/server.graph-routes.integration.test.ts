...
import { getGraphRouteSchema } from "./lib/fastify/openapi/generated/operations/get-graph.ts";
import { listGraphsRouteSchema } from "./lib/fastify/openapi/generated/operations/list-graphs.ts";
import { updateGraphRouteSchema } from "./lib/fastify/openapi/generated/operations/update-graph.ts";
  ...
  await t.test("supports full graph CRUD flow", async () => {
    ...
    try {
      ...
      assert.deepStrictEqual(
        listGraphsRouteSchema.response[200].parse(parseJson(emptyListResponse)),
        [],
      );
      ...
      assert.deepStrictEqual(
        getGraphRouteSchema.response[200].parse(parseJson(getGraphResponse)),
        createdGraph,
      );
      ...
      const updatedGraph = updateGraphRouteSchema.response[200].parse(
        parseJson(updateGraphResponse),
      );
      ...
      assert.deepStrictEqual(
        listGraphsRouteSchema.response[200].parse(parseJson(listAfterUpdateResponse)),
        [updatedGraph],
      );
      ...
      assert.deepStrictEqual(
        listGraphsRouteSchema.response[200].parse(parseJson(deletedListResponse)),
        [],
      );
